...
<html>
    <head>
        ...
        <title>CarMe Add New Member</title>
    ...
    <body>
            ...
            {	
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            $successMsg = "Successful Addition of New Member for " .$fname;
                        ...
                        {
                            $conErr = "Failed Addition of New Member.";
        ...
        <div class="heading-text" id="heading-text">
            <h2>Create a New Member Account Manually by Admin:</h2>
        </div>
        ...
        <div class="mr-form-container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                ...
                <div class="buttons">
                    <a href="members.php" class="mr-cncl-button" id="mr-cncl-button">Cancel</a>
