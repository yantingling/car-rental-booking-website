...
<html lang="en">
    <head>
        ...
        <title>CarMe Edit Member Profile</title>
    ...
    <body>
        ...
        <div class="emp-form-container">
            <form action="validate_edit_member.php?key_id=<?php echo $memberID;?>" method="POST">
                ...
                <div class="buttons">
                    <a href="profile.php" class="emp-cncl-button" id="emp-cncl-button">Cancel</a>
