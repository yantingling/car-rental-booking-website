...
<html lang="en">
    <head>
        ...
        <title>CarMe Admin Forgot Password</title>
    ...
    <body>
        ...
        <div class="fp-form-container">
            <form action="email_afp.php" method="POST">
                ...
                <div class="buttons">
                    <a href="admin_login.php" class="fp-cncl-button" id="fp-cncl-button">Back to Log In</a>
